...
class DateExpenseDialog extends StatelessWidget {
  const DateExpenseDialog({super.key});

  @override
  Widget build(BuildContext context) {
    Provider.of<ExpenseProvider>(context,listen: false).getExpenseByDateProvider();
    Provider.of<ExpenseProvider>(context,listen: false).getDateTotalCashInProvider();
    Provider.of<ExpenseProvider>(context,listen: false).getDateTotalCashOutProvider();
            ...
            children: [
              ...
              Container(
                ...
                child: ListView.builder(
                    itemCount: expenseProvider.getExpenseByDate.length,
                    itemBuilder: (context,index){
                      ExpenseModel mdl = expenseProvider.getExpenseByDate[index];
